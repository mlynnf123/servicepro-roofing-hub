    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {/* Large feature card */}
          <div className="lg:col-span-2 lg:row-span-2 bg-gradient-to-br from-servicepro-navy to-servicepro-navy/90 p-8 rounded-3xl text-white card-hover shadow-xl">
            <div className="h-full flex flex-col justify-between">
              <div>
                <div className="bg-servicepro-orange/20 p-3 rounded-2xl w-fit mb-6">
          ...
          {/* Document management */}
          <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 card-hover">
            <div className="bg-servicepro-orange/10 p-3 rounded-2xl w-fit mb-6">
          ...
          {/* Communication hub */}
          <div className="lg:col-span-2 bg-gradient-to-r from-servicepro-orange to-servicepro-orange/90 p-8 rounded-3xl text-white card-hover shadow-xl">
          ...
          {/* Analytics dashboard */}
          <div className="lg:col-span-2 bg-white p-8 rounded-3xl shadow-lg border border-gray-100 card-hover">
            <div className="flex items-center justify-between mb-6">
              <div className="bg-servicepro-orange/10 p-3 rounded-2xl">
